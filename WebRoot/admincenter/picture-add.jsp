...
<![endif]-->
<title>新增图片</title>
<link href="../membercenter/lib/webuploader/0.1.5/webuploader.css"
...
<body>
	...
	<div class="page-container">
		<form class="form form-horizontal" id="form-article-add" method="post"
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red"></span>所屬分類：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<span class="select-box"> <select name="category.id"
						class="select">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">基本數據：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<table class="table table-border table-bordered table-bg">
						<thead>
							<tr class="text-c">
								<th width="100">商品貨號</th>
								<th width="50">庫存</th>
								<th width="50">市場價格</th>
								<th width="50">銷售價格</th>
							</tr>
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red"></span>產品縮圖：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="file" class="input-text" name="upload"
						style="width: 50%" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">產品描述：</label>
				<div class="formControls col-xs-8 col-sm-9">
			...
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<input type="submit" class="btn btn-secondary radius" value="上傳商品" />
	...
	<!--请在下方写此页面业务相关的脚本-->
	<script type="text/javascript"
		src="../membercenter/lib/jquery.validation/1.14.0/jquery.validate.js"></script>
	<script type="text/javascript"
		src="../membercenter/lib/jquery.validation/1.14.0/validate-methods.js"></script>
	<script type="text/javascript"
		src="../membercenter/lib/jquery.validation/1.14.0/messages_zh.js"></script>
	<script type="text/javascript"
		src="../membercenter/lib/webuploader/0.1.5/webuploader.min.js"></script>
	<script type="text/javascript">
