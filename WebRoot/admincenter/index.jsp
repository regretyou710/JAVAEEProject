...
<body>
		...
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				<a class="logo navbar-logo f-l mr-10 hidden-xs"
					href="../adminlogin/html/index.jsp">Happy購</a> <a
					class="logo navbar-logo-m f-l mr-10 visible-xs"
					href="../adminlogin/html/index.jsp">Happy購</a> <span
				...
				<dd>
					<ul>
						...
						<li><a data-href="product-list.html" data-title="產品管理"
							href="javascript:void(0)">產品管理</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-member">
	...
	<div class="contextMenu" id="Huiadminmenu">
		<ul>
			<li id="closethis">關閉當前</li>
			<li id="closeall">關閉全部</li>
		</ul>
	</div>
	<!--_footer 作为公共模版分离出去-->
